...
<<<<<<< HEAD
		...
		<div class="col-md-7">
			<a href="#"> <img class="img-responsive"
				src="http://placehold.it/450x450" alt="">
			</a>
		</div>
							...
							<div class="box box-primary">
								...
								<form class="input">
									<ul>
										<li>Title<br> <input type="text"></li>
										
										<li>Singer<br> <input type="text"></li>
										
										<li>RegDate<br> <input type="text"></li>
									</ul>
									<div class="box-footer">
										<button type="submit" class="rBtm">Submit</button>
									</div>
								</form>
							</div>
						</div>
